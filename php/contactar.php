...
$sql = "INSERT INTO contacto (nombres, correo, asunto, mensaje, fecha_registro, id_estado) VALUES ('$nombres', '$correo', '$asunto', '$mensaje',current_timestamp(),'1')";
...
$mail->Username = 'contactocajay@municarabayllo.gob.pe'; // Reemplaza 'tu_correo@gmail.com' con tu dirección de correo
$mail->Password = 'ASD.159'; // Reemplaza 'tu_contraseña' con tu contraseña de correo
$mail->SMTPSecure = 'tls';
//$mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;
$mail->Port = 25;
...
// // Recipients
$mail->setFrom('contactocajay@municarabayllo.gob.pe', 'Municipalidad Distrital de Cajay');
          	...
          	<table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
          		<tr>
          			<td class="logo" style="text-align: center;">
			            <h1><a href="">Gracias por contactarnos</a></h1>
			          </td>
          		</tr>
          	</table>
          </td>
                  ...
                  <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                    <tr>
                      <td style="text-align: left; padding-left: 5px; padding-right: 5px;">
                      	...
                      	<ul>
					                <li><span class="text">Municipalidad Distrital de Cajay | Av. Pedro Aguirre S/N.Plaza de Armas Cajay, Huari,</span></li>
